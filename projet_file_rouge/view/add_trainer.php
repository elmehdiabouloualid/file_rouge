   ...
   <div class="container">
    ...
    <ul>
      <li><a href="admin_dashbord.php">Members</a></li>
        ...
        <li><a href="add_trainer.php" class="active">Add new Trainer</a></li>
...
<input type="submit" class="btn btn-primary" name="tra_submit" value="Register" style="background-color: #fff; color: #000; border: none; cursor: pointer;">
</form>
     </div>
    </div>
    </div>
